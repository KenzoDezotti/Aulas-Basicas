"""aula 73 
debugando programas com PDB

bugs são problemas que o programador cometeu porem nao são considerados erros que levantem excessão,
uma variavel não declarada, uma variavel que nao se comportou da maneira correta, ou outra coisa que o python
não consegue identificar e classificar como Error
"""
